...
wscat -H "x-auth-key: $APIKEY" \
  ...
  -c wss://ascendex.com/1/api/pro/v1/stream -w 1 -x '{"op":"sub", "id": "abc123", "ch": "order:cshQtyfq8XLAA9kcf19h8bXHbAwwoqDo:BTMX/USDT"}'
```
...
* Python for [websocket auth](https://github.com/ascendex/ascendex-pro-api-demo/blob/master/python/websocket_auth.py)
